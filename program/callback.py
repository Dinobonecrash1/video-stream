        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [                    
                    ...
                    InlineKeyboardButton("• Cʜᴀᴛᴢᴏɴᴇ", url=f"https://t.me/Anime_Chat_Guardians"),
                    InlineKeyboardButton(" Cʜᴀᴛᴢᴏɴᴇ •", url=f"https://t.me/guardians_Bot_Updates")
               ],[
                    InlineKeyboardButton("📨 Sᴜᴘᴘᴏʀᴛ", url=f"https://t.me/Anime_Chat_Guardians"),
                    InlineKeyboardButton(" Uᴘᴅᴀᴛᴇs 📨", url=f"https://t.me/guardians_Bot_Updates")
                ],[
